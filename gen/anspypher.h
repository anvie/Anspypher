...
#ifndef __gen_anspypher_h__
#define __gen_anspypher_h__
...
class Transporter;
bool operator==(const Transporter&, const Transporter&);
bool operator<(const Transporter&, const Transporter&);
...
class Callback_Transporter_sendSR_Base : virtual public ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_Transporter_sendSR_Base> Callback_Transporter_sendSRPtr;
...
class Transporter : virtual public ::IceProxy::Ice::Object
{
public:
    ...
    void end_sendSR(const ::Ice::AsyncResultPtr&);
...
public:
    ...
    ::IceInternal::ProxyHandle<Transporter> ice_context(const ::Ice::Context& __context) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_context(__context).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_context(__context).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_adapterId(const std::string& __id) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_adapterId(__id).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_adapterId(__id).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_endpoints(const ::Ice::EndpointSeq& __endpoints) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_endpoints(__endpoints).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_endpoints(__endpoints).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_locatorCacheTimeout(int __timeout) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_locatorCacheTimeout(__timeout).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_locatorCacheTimeout(__timeout).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_connectionCached(bool __cached) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_connectionCached(__cached).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_connectionCached(__cached).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_endpointSelection(::Ice::EndpointSelectionType __est) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_endpointSelection(__est).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_endpointSelection(__est).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_secure(bool __secure) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_secure(__secure).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_secure(__secure).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_preferSecure(bool __preferSecure) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_preferSecure(__preferSecure).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_preferSecure(__preferSecure).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_router(const ::Ice::RouterPrx& __router) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_router(__router).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_router(__router).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_locator(const ::Ice::LocatorPrx& __locator) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_locator(__locator).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_locator(__locator).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_collocationOptimized(bool __co) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_collocationOptimized(__co).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_collocationOptimized(__co).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_twoway() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_twoway().get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_twoway().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_oneway() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_oneway().get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_oneway().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_batchOneway() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_batchOneway().get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_batchOneway().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_datagram() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_datagram().get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_datagram().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_batchDatagram() const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_batchDatagram().get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_batchDatagram().get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_compress(bool __compress) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_compress(__compress).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_compress(__compress).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_timeout(int __timeout) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_timeout(__timeout).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_timeout(__timeout).get());
    #endif
    }
    
    ::IceInternal::ProxyHandle<Transporter> ice_connectionId(const std::string& __id) const
    {
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Transporter*>(_Base::ice_connectionId(__id).get());
    #else
        return dynamic_cast<Transporter*>(::IceProxy::Ice::Object::ice_connectionId(__id).get());
    #endif
    }
...
class Transporter : virtual public ::IceDelegate::Ice::Object
{
public:
...
class Transporter : virtual public ::Ice::Object
{
public:

    typedef TransporterPrx ProxyType;
    typedef TransporterPtr PointerType;
...
inline bool operator==(const Transporter& l, const Transporter& r)
{
    return static_cast<const ::Ice::Object&>(l) == static_cast<const ::Ice::Object&>(r);
}
...
template<class T>
class CallbackNC_Transporter_sendSR : public Callback_Transporter_sendSR_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
    ...
    CallbackNC_Transporter_sendSR(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallbackNC<T>(obj, cb, excb, sentcb)
    {
    }
};

template<class T> Callback_Transporter_sendSRPtr
newCallback_Transporter_sendSR(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Transporter_sendSR<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_Transporter_sendSRPtr
newCallback_Transporter_sendSR(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Transporter_sendSR<T>(instance, 0, excb, sentcb);
}

template<class T> Callback_Transporter_sendSRPtr
newCallback_Transporter_sendSR(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Transporter_sendSR<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_Transporter_sendSRPtr
newCallback_Transporter_sendSR(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Transporter_sendSR<T>(instance, 0, excb, sentcb);
}

template<class T, typename CT>
class Callback_Transporter_sendSR : public Callback_Transporter_sendSR_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
    ...
    Callback_Transporter_sendSR(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallback<T, CT>(obj, cb, excb, sentcb)
    {
    }
};

template<class T, typename CT> Callback_Transporter_sendSRPtr
newCallback_Transporter_sendSR(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Transporter_sendSR<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_Transporter_sendSRPtr
newCallback_Transporter_sendSR(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Transporter_sendSR<T, CT>(instance, 0, excb, sentcb);
}

template<class T, typename CT> Callback_Transporter_sendSRPtr
newCallback_Transporter_sendSR(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Transporter_sendSR<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_Transporter_sendSRPtr
newCallback_Transporter_sendSR(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Transporter_sendSR<T, CT>(instance, 0, excb, sentcb);
}
